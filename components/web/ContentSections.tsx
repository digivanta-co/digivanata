...
export function IntroSection() {
  return (
    <section className="relative bg-white py-20 lg:py-28 border-t border-[var(--gd-line)]">
...
export function WebWhyGridSection() {
  return (
    <section className="relative bg-white py-20 border-t border-[var(--gd-line)]">
...
export function AuthorSection() {
  return (
    <section id="web-author" className="relative bg-[var(--gd-soft)] py-20 border-t border-[var(--gd-line)]">
